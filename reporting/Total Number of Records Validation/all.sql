...
SELECT 'SQUATTER_USE & SQUATTER_MATERIAL_PRO' AS "TABLE_NAME",
       ...
       (SELECT COUNT(*) FROM SQ.SQUATTER_USES s WHERE s.OBJECT_ID IS NOT NULL ) AS "SUCCESS"
FROM dual
UNION ALL
SELECT 'SQUATTER_MATERIAL & SQUATTER_MATERIAL_PRO' AS "TABLE_NAME",
       ...
       (SELECT COUNT(*) FROM SQ.SQUATTER_MATERIALS s WHERE s.OBJECT_ID IS NOT NULL) AS "SUCCESS"
FROM dual
UNION ALL
