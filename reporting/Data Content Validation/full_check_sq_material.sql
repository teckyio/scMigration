TRUNCATE TABLE data_validation_squatter_material;
DECLARE quantity INT := 0;
BEGIN -- Insert data into the table with validation checks
INSERT INTO data_validation_squatter_material (
    objectid,
    target_ObjectId,
    error_msg,
    is_valid,
...
SELECT rec.objectid AS objectid,
  ...
  END AS is_valid,
  sq.dlo_id as dlo
FROM SDE_SQ.SQUATTERMATERIAL rec
...
END;
SELECT *
FROM data_validation_squatter_material;