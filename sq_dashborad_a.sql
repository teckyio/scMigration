...
LEFT JOIN SQUATTER_POLYS sp ON s.SQUATTER_ID = sp.SQUATTER_ID
LEFT JOIN ATTACHMENT_SQ asq ON s.ID = asq.SQUATTER_GUID
LEFT JOIN ATTACHMENTS a ON asq.Attachment_Id = a.ID
...
GROUP BY 
    ...
    s.SURVEY_No_PREFIX || s.SURVEY_NO, s.SURVEY_NO, sp.SHAPE;
