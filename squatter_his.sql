...
BEGIN
    FOR rec IN (
        ...
        BEGIN
            ...
            INSERT INTO NEWDB.SQUATTER_HISTORIES (
                SQUATTER_GUID, OBJECT_ID, SQUATTER_ID, DIMENSIONS_L, DIMENSIONS_B, DIMENSIONS_H, 
        ...
        EXCEPTION
            WHEN OTHERS THEN
                ...
                log_error('SQUATTER_HISTORIES', v_error_message);
        END;
    END LOOP;
END;
